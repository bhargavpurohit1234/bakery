...
if(isset($_POST['cmdsubmit']))
{
	if($_POST['action']=='Edit')
	{
		...
		$query = "update category_master set name ='".$cat."' where id = '".$_POST['id']."'  ";
		$result = mysql_query($query);
		echo '<script language="javascript">alert("Category Updated Successfully") ; </script>"'	;
		echo '<script language="javascript">document.location="category_view.php";</script>"'	;		
		exit;
	...
	else
	{
		...
		$cat = trim($_POST['category']);
		$query = "insert into category_master (name) values ('".$cat."')";
		$result = mysql_query($query);
...
{
	$query = "select * from category_master where id ='".$_GET['editId']."'";
	$result = mysql_query($query);
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="category" class="form-control" id="category" required value="<?php echo $cat ; ?>"/>
                                            </div>                                            
